...
#include <stdio.h>
void funN()									//naèítanie do pov. pola
{
	FILE*sifra;
	char povText[1000];
	char ch;
...
void funU()								//naèítanie do upr. pola
{
	int i=0,f=0;
...

{
  ...
  switch (ch)								//Switch case vo while, aby sa priíkazy mohli opakova do kola, do kial sa nestlaci k. 
  {
...
//Program som robil v DevC++ a tam mi všetko išlo, len turing mi to nechce zobra. 
